...
```
$ curl -L -O https://github.com/source-foundry/ttfautohint-build/archive/v1.8.1.1.tar.gz
$ tar -xzvf ttfautohint-build-1.8.1.1.tar.gz
$ cd ttfautohint-build-1.8.1.1
$ make
```
